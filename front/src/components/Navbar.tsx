...
export default function Navbar() {
  ...
  return (
    <nav className="px-3 md:max-w-2xl m-auto fixed top-0 left-0 right-0 p-1 h-[--nav-height] z-10 flex items-center justify-between bg-white shadow-[0_4px_6px_-4px_gray]">
